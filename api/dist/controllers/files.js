...
exports.getImage = exports.getDocuments = void 0;
...
var getImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                url_2 = path_1["default"].join(__dirname, "../image/" + req.params.data + ".jpg");
                console.log(url_2);
                fs_1["default"].access(url_2, fs_1["default"].constants.F_OK, function (err) {
                    console.log(url_2 + " " + (err ? "is not writable" : "is writable"));
                });
                return [4 /*yield*/, fs_1["default"].readFile(url_2, function (err, data) {
                        if (err) {
                            res.status(500).json({ msg: "Error al leer el archivo" });
                            //   console.log(err);
                        }
